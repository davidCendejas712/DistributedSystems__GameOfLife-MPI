...
int main(int argc, char* argv[]){
	...
	double startTime, endTime;
		...
		if (rank == MASTER){		
			...
			invocarMaster(window, renderer, size, worldWidth, worldHeight, distModeStatic, grainSize, totalIterations, outputFile, autoMode);
		...
		// Workers
			...
			invocarWorker(worldWidth, worldHeight);
